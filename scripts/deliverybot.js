...
const usersNumber = document.getElementsByClassName('impact__digits__number-users')[0]; // элемент количества установок
observerDigits.observe(usersNumber); // наблюдаем за появлением элемента количества установок
