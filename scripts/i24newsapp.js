...
const installsNumber = document.getElementsByClassName('impact__digits__number-installs')[0]; // элемент количества установок
observerDigits.observe(installsNumber); // наблюдаем за появлением элемента количества установок
